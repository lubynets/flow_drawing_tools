...
//   SetSelectAxisBinEdges({0, 40});
//   SetSliceAxisBinEdges({0, 0.6, 0.9, 1.2});
//   SetSliceAxisBinEdges({0, 0.5, 1});
...
//     v1_sim.Scale(2);
    ...
    auto v1_rec_nofit = DoubleDifferentialCorrelation( fileMcName.c_str(),
                                                {("v1/uQ_R1_sub4_sts_pipos/v1.u_rec_sgnl_RESCALED.psd2_RECENTERED.res_sub4_sts_pipos." + component_1).c_str(),
                                                 ("v1/uQ_R1_sub4_sts_pipos/v1.u_rec_sgnl_RESCALED.psd2_RECENTERED.res_sub4_sts_pipos." + component_2).c_str() } );
//     auto v1_rec_nofit = DoubleDifferentialCorrelation( fileMcName.c_str(),
...
//     v1_rec_nofit.Scale(2);
    ...
    v1_rec_nofit.SetPalette({kOrange+1, kSpring, kGreen+2, kAzure-4, kRed, kViolet, kBlue});
...
//     v1_rec_fit.Scale(2);
    ...
    v1_rec_fit.SetPalette({kOrange+1, kSpring, kGreen+2, kAzure-4, kRed, kViolet, kBlue});
